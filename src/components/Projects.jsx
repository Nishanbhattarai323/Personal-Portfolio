...
import { Box, Container, Grid, Tab, Tabs, Typography, Card, CardContent, CardMedia, Chip, Button, CardActions } from "@mui/material";
  ...
  return (
    <Card sx={{ maxWidth: 345, paddingBottom: 4 }}>
      ...
      <CardActions sx={{ justifyContent: "space-between", pb: 2 }}>
        <Button size="small" startIcon={<Github />} href={project.github} target="_blank" rel="noopener noreferrer">
          Code
        </Button>
        <Button size="small" startIcon={<ExternalLink />} href={project.demo} target="_blank" rel="noopener noreferrer">
          Demo
        </Button>
      </CardActions>
    </Card>
...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "An AI-powered application that generates unique images from text descriptions using machine learning.",
